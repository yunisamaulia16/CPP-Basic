...
int main(){ //main program tipe integer
	...
	cout<<"DAFTAR OBAT APOTEK PEDULI LINDUNGI :"<<endl;//cetak kaliumat "PEDULI LINDUNGI"
	...
	if (pilihanobat == 'A'  || pilihanobat =='a'){ //jika pilihan obat adalah a atau A 
		...
		hargaobat=30000;
	}else if (pilihanobat == 'F' || pilihanobat == 'f'){
		hargaobat=35000;
	}else{
	...
	case 2:
		cout<<"List obat Nyeri Otot"<<endl;//List obat Nyeri Otot"
...
cout<<"Berapa Banyak Obat Yang Akna Dibeli? ";
cin>>banyak;
